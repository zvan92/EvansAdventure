...
void MapManager::CreateRooms()
{
	...
	roomMap["H5"] = Room(1, 0, 1, 0, 0, 0, 0, 1);
	roomMap["H6"] = Room(1, 0, 0, 1, 0, 0, 1, 0);
	// G ROW
	...
	roomMap["D2"] = Room(1, 1, 0, 0, 0, 0, 0, 1);
	roomMap["D3"] = Room(1, 0, 0, 0, 0, 0, 1, 0);
	...
	roomMap["C4"] = Room(1, 0, 1, 0, 0, 0, 0, 0); // needs south door - testing try/catch
	...
	roomMap["C11"] = Room(0, 0, 1, 0, 1, 0, 0, 0);
	...
	roomMap["B6"] = Room(1, 1, 0, 0, 0, 0, 0, 1);
	roomMap["B7"] = Room(0, 1, 0, 0, 0, 0, 1, 0);
